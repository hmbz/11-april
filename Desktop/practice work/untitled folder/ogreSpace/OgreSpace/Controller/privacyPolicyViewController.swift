...
// // var titleview = Bundle.main.loadNibNamed("TopFoerEveryViewController ", owner: self, options: nil)?.first as! TopForEveryViewCOntroller
...
//  //MARK:- View Life cycle
  override func viewDidLoad() {
    super.viewDidLoad()
//    self.policyText.layoutIfNeeded()
//    self.policyText.setContentOffset(CGPoint.zero, animated: false)
  topBAr()
